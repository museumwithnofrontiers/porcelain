...
The **Museum With No Frontiers — Porcelain** gallery, built from the published
dataset `@museumwnf/porcelain-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/porcelain-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/porcelain/> through the reusable workflows in
