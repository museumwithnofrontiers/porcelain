...
// `useGalleryData.js` used to be byte-identical local copies of what porcelain
...
// legacy project key, no UUID — porcelain shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (porcelain-data 1.0.11+), an outside
