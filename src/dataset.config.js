...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'porcelain',
  ...
  home: {
    title: 'porcelain.identity.title',
    intro: 'porcelain.home.intro',
    cards: [
      {
        title: 'porcelain.nav.catalogue',
        description: 'porcelain.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'porcelain.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'porcelain.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'porcelain.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'porcelain.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'porcelain.partnerObjects.emptyPartner',
  //         emptyInstitution: 'porcelain.partnerObjects.emptyInstitution',
  //         institutionSummary: 'porcelain.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'porcelain.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'porcelain.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
